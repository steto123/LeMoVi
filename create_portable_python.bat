...
%PYTHON_EXE% -m pip install --no-cache-dir PyQt5 PyQtWebEngine PyQt5-sip paramiko
...
%PYTHON_EXE% -c "import rdkit; import PyQt5; import opi; import paramiko; print('Verification: RDKit, PyQt5, OPI, and Paramiko ready.')"
if %ERRORLEVEL% NEQ 0 (
