...
- **Dateiverwaltung & Integrationen**:
  ...
  - **Setup-Dialog**: Intuitiver Dialog zur Konfiguration quantenchemischer Rechnungen (Aufgaben: `Opt`, `Freq`, `NMR`, `Single Point` sowie Kombinationen; Methoden: DFT-Funktionale wie `B3LYP`, `PBE0`, `wB97X-D4`, `r2SCAN-3c`, NMR-Spezialfunktionale wie `mPW1PW91`, `BMK`, `WC04`, `WP04`, HF/semi-empirisch oder Post-HF wie `MP2` und `DLPNO-CCSD(T)`).
