...
- **File Management & Integrations**:
  ...
  - **Setup Dialog**: Intuitive dialog to configure quantum chemical calculations (Tasks: `Opt`, `Freq`, `NMR`, `Single Point` and combinations; Methods: DFT functionals like `B3LYP`, `PBE0`, `wB97X-D4`, `r2SCAN-3c`, NMR-specialized functionals like `mPW1PW91`, `BMK`, `WC04`, `WP04`, HF/semi-empirical, or post-HF like `MP2` and `DLPNO-CCSD(T)`).
